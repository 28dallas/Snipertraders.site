          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { icon: MessageCircle, label: 'Telegram (Fastest)', value: '@SniperTradersBot', href: 'https://t.me/snipertraders', color: 'text-blue-400', bg: 'bg-blue-400/10' },
                  { icon: Mail, label: 'Email Support', value: 'support@snipertraders.com', href: 'mailto:support@snipertraders.com', color: 'text-primary', bg: 'bg-primary/10' },
